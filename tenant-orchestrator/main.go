...
import (
	...
	"github.com/grg-automation/multi-saas-crm/tenant-orchestrator/controllers"
	...
	"sigs.k8s.io/controller-runtime/pkg/log/zap" // Use this for logging
...
func main() {
    ...
    healthMonitor := health.NewMonitor(mgr.GetClient(), discoveryClient)
