  ...
  useEffect(() => {
    ...
    if (token && userData && userData !== 'undefined' && userData !== 'null') {
      try {
        ...
        // Убираем автоматическое перенаправление - пользователь может сам выбрать куда идти
      } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center">
          ...
          <Link href="/inbox" className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 hover:shadow-xl transition-all transform hover:scale-105 text-white">
            <div className="text-center">
