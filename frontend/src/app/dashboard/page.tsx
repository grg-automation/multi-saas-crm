...
import { Building, DollarSign, Target, Users } from 'lucide-react'
			...
			const recentActivities = [
				{
					type: 'opportunity',
					action: 'created',
					title: 'Новая сделка с Tech Corp',
					time: '2 часа назад',
				},
				{
					type: 'contact',
					action: 'updated',
					title: 'Обновлен контакт John Smith',
					time: '4 часа назад',
				},
				{
					type: 'company',
					action: 'created',
					title: 'Добавлена компания StartupXYZ',
					time: '1 день назад',
				},
				{
					type: 'opportunity',
					action: 'closed',
					title: 'Закрыта сделка на $25,000',
					time: '2 дня назад',
				},
			]
			...
			<div className='max-w-7xl mx-auto p-6'>
				...
				<div className='mb-8'>
					...
					<p className='text-gray-600 mt-2'>
						Обзор ключевых метрик и аналитики
					</p>
				</div>
								...
								>
									<div>
										<h3 className='font-medium'>
											{opportunity.title || 'Без названия'}
										</h3>
